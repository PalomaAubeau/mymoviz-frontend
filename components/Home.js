...
function Home() {
  ...
  useEffect(() => {
    fetch("https://mymoviz-backend-beige.vercel.app/movies")
      .then((response) => response.json())
      .then((data) => {
        setMoviesData(data.movies); // data est un objet avec une clé result à true, et une clé movies qui contient un tableau d'objets
      });
  }, []);
